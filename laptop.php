			...
			<div class="container">
				...
				<div class="title-menu">
					<ul>
						...
						<li><strong>></strong></li>
						<li><a href="">Laptop (69 sản phẩm)</a></li>
						<li>></li>
						<li class="sub-menu"><a href="">Mức giá <img style="width:10px" src="img/icon/drop-down.png" alt=""></a>
							<ul >
								<li><a href="">Tất cả</a></li>
								<li><a href="">Dưới 8 triệu</a></li>
								<li><a href="">Từ 8 đến 10 triệu</a></li>
								<li><a href="">Từ 10 đến 12 triệu</a></li>
								<li><a href="">Từ 12 đến 15 triệu</a></li>
