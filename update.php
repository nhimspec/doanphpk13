						...
						<table >
							<form action="" method="post">
								<label for="tk">
									<tr>
										<td>
											<input type="text" placeholder="Tìm kiếm tên sản phẩm" id="tk" >
										</td>
										<td id="fix-td">
											<input type="submit" name="find" value="Tìm kiếm" id="find-tk">
										</td>
									</tr>
								</label>
							...
							<div class="chung col-md-12">
								...
								<div class="phonesale">
									...
									<div class="quangcao">
										<?php 
											//string to array
											$chuoi=explode(",",$data["khuyenmai"]);
											$d=count($chuoi);
										?>
										<label class="khuyenmai">Có <?php echo $d; ?> khuyến mãi</label>
										<ul>
											<?php 
												//show chuoi
												for($i=0;$i<$d;$i++)
